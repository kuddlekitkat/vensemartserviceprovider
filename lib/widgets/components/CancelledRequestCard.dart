...
class CancelledRequestCard extends StatelessWidget {
  ...
  CancelledRequestCard({Key? key, required this.CancelledRequestModel}) : super(key: key);
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children:  [
                  Text('New Cancelled Request'),
                  // Text('${CancelledRequestModel?.name}' ?? ''),
                Flexible(
                  child: RichText(
                  ...
                  // Text('From: ${CancelledRequestModel?.name}'),
                  Text('${CancelledRequestModel?.bookingDate}'),
                  Text('${CancelledRequestModel?.bookingTime}'),
                ],
              ),
            ),
            SizedBox(width: 20.0,),
