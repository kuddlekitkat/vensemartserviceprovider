...
class AuthRepo with ApiServices {
  Future<Response?> login(Map<String, String> credentials) async {
    Response? response =
        await apiPostRequests("service_pro_login", credentials);
  ...
  Future<Response?> register(Map<String, String> credentials) async {
    Response? response =
        await apiPostRequests("service_pro_register", credentials);
  ...
  Future<Map<String, dynamic>?> updateProfile(
    ...
    Map<String, dynamic>? response =
        await apiUploadPostRequests("service_update_profile", credentials);
